...
var _tet54$octagon$Native_Audio = function() {
...
var _tet54$octagon$Audio$stopSound = _tet54$octagon$Native_Audio.stopSound;
var _tet54$octagon$Audio$playSound = _tet54$octagon$Native_Audio.playSound;
var _tet54$octagon$Audio$loadSound = _tet54$octagon$Native_Audio.loadSound;
var _tet54$octagon$Audio$PlaybackOptions = F3(
	function (a, b, c) {
		return {volume: a, startAt: b, loop: c};
	});
var _tet54$octagon$Audio$defaultPlaybackOptions = A3(
	_tet54$octagon$Audio$PlaybackOptions,
	1.0,
	_elm_lang$core$Maybe$Just(0.0),
	false);
var _tet54$octagon$Audio$Sound = {ctor: 'Sound'};
		...
		A4(
			...
			A3(
				...
				_tet54$octagon$Main$gameHeight,
				{
					...
					_1: {
						ctor: '::',
						_0: A2(_evancz$elm_graphics$Collage$rotate, game.autoRotateAngle, field),
						_1: {
							ctor: '::',
							_0: A2(
...
var _tet54$octagon$Main$onUserInput = F2(
	function (keyMsg, game) {
		...
		var nextState = function () {
			...
			switch (_p11.ctor) {
				case 'NewGame':
					return spacebar ? _tet54$octagon$Main$Play : _tet54$octagon$Main$NewGame;
				case 'Play':
					return spacebar ? _tet54$octagon$Main$Pause : _tet54$octagon$Main$Play;
				case 'GameOver':
					return spacebar ? _tet54$octagon$Main$NewGame : _tet54$octagon$Main$GameOver;
				case 'Pause':
					return spacebar ? _tet54$octagon$Main$Play : _tet54$octagon$Main$Pause;
				default:
					return game.state;
			}
		}();
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _tet54$octagon$Main$main !== 'undefined') {
    _tet54$octagon$Main$main(Elm['Main'], 'Main', undefined);
}
